...
auth_bp.get("/users/staff")(roles_required("admin", "supervisor")(permission_required("users_read")(get_staff_user)))
auth_bp.patch("/users/staff")(roles_required("admin", "supervisor")(permission_required("users_update")(update_staff_user)))
auth_bp.delete("/users/staff")(roles_required("admin", "supervisor")(permission_required("users_delete")(delete_staff_user)))
